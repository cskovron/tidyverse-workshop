...
[R for Data Science](r4ds.had.co.nz) is freely available online. I encourage you to read all of it. We will only cover what I think are the most important chapters in these two days. 
...
- RStudio has a separate "Master the Tidyverse" class that has a lot of exercises on various aspects of the tidyverse. Some of the exercises are on parts of the tidyverse we won't cover, but you should be able to get most of them. 
